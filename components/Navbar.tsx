                            ...
                            <div className="flex items-center">
                                   ...
                                   <div className="hidden md:block">
                                          <div className="ml-10 flex items-center space-x-4">
                                                 <Link href="/">
                                                        <a className=" text-blue-600 hover:bg-blue-800 hover:text-white px-3 py-2 rounded-xl text-sm font-medium">
                                                               Homepage
                                                        </a>
                                                 </Link>
                                                 <Link href="/tickets">
                            ...
                            {(ref: any) => (
                                   <div className="md:hidden" id="mobile-menu">
                                          <div ref={ref} className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                                                 <Link
                                                        href="/">
                                                        <a className="hover:bg-blue-800 text-sm text-blue-600 hover:text-white block px-3 py-2 rounded-md font-medium">
                                                               Homepage
                                                        </a>
                                                 </Link>

                                                 <Link href="/tickets">
                                                        <a className="text-blue-600 text-sm hover:bg-blue-800 hover:text-white block px-3 py-2 rounded-md font-medium">
                                                               Tickets
                                                        </a>
                                                 </Link>
