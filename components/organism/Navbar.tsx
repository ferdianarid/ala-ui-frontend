...
function Navbar() {
       ...
       return (
              <nav className="w-full fixed z-40 bg-white top-0 px-4 md:px-32">
                     <div className="flex items-center justify-between">
                            ...
                            <div className="-mr-2 flex md:hidden">
                                   <button
                                          ...
                                          type="button"
                                          className="bg-white inline-flex items-center justify-center p-2 rounded-md text-gray-900 hover:text-white hover:bg-yellow-500 focus:outline-none "
